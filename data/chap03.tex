...
在对时间序列的对称度进行度量之前，需要执行一步非常重要的操作，
...
\begin{figure}
  ...
  {\includegraphics[width=0.49\linewidth]{truck_lo.png}}
  \subcaptionbox{心率FSR信号\label{fig:data_range-b}}
  {\includegraphics[width=0.49\linewidth]{heart_fsr.png}}
...
\begin{figure}
  \centering
  \includegraphics[width=0.66\linewidth]{frontend_match.png}
