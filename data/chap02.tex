...
\begin{figure}
  \centering
  \subcaptionbox{单条对称子段\label{fig:global_symmetry_result}}
    {\includegraphics[width=0.49\linewidth]{global_symmetry_result.png}}
  \subcaptionbox{多条对称子段\label{fig:segmented_symmetry_result}}
...
动态时间扭曲（DTW）算法从全局角度度量和计算时间序列的相似度，度量结果
...
\begin{figure}
  \centering
  \includegraphics[width=0.66\linewidth]{fastdtw.PNG}
