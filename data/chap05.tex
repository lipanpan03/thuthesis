...
\begin{figure}
  \centering
  \includegraphics[width=0.76\linewidth]{symmetry.pdf}
...
\begin{figure}
  \centering
  \includegraphics[width=0.76\linewidth]{accuracy.pdf}
...
\begin{figure}
  ...
  {\includegraphics[width=0.49\linewidth]{sin_1.png}}
  \subcaptionbox{合成数据集\label{fig:sin_2}}
  {\includegraphics[width=0.49\linewidth]{sin_2.png}}
  \subcaptionbox{GPS轨迹数据集\label{fig:truck_1}}
  {\includegraphics[width=0.49\linewidth]{truck_1.png}}
  \subcaptionbox{GPS轨迹数据集\label{fig:truck_2}}
  {\includegraphics[width=0.49\linewidth]{truck_2.png}}
  \subcaptionbox{工况数据集\label{fig:excavator_1}}
  {\includegraphics[width=0.49\linewidth]{excavator_1.png}}
  \subcaptionbox{工况数据集\label{fig:excavator_2}}
  {\includegraphics[width=0.49\linewidth]{excavator_2.png}}
  \subcaptionbox{金融数据集\label{fig:stock_1}}
  {\includegraphics[width=0.49\linewidth]{stock_1.png}}
  \subcaptionbox{金融数据集\label{fig:stock_2}}
  {\includegraphics[width=0.49\linewidth]{stock_2.png}}
...
\begin{figure}
  ...
  {\includegraphics[width=0.49\linewidth]{sin_time_1.png}}
  \subcaptionbox{合成数据集\label{fig:sin_time_2}}
  {\includegraphics[width=0.49\linewidth]{sin_time_2.png}}
  \subcaptionbox{GPS轨迹数据集\label{fig:truck_time_1}}
  {\includegraphics[width=0.49\linewidth]{truck_time_1.png}}
  \subcaptionbox{GPS轨迹数据集\label{fig:truck_time_2}}
  {\includegraphics[width=0.49\linewidth]{truck_time_2.png}}
  \subcaptionbox{工况数据集\label{fig:excavator_time_1}}
  {\includegraphics[width=0.49\linewidth]{excavator_time_1.png}}
  \subcaptionbox{工况数据集\label{fig:excavator_time_2}}
  {\includegraphics[width=0.49\linewidth]{excavator_time_2.png}}
  \subcaptionbox{金融数据集\label{fig:stock_time_1}}
  {\includegraphics[width=0.49\linewidth]{stock_time_1.png}}
  \subcaptionbox{金融数据集\label{fig:stock_time_2}}
  {\includegraphics[width=0.49\linewidth]{stock_time_2.png}}
