...
\begin{figure}
  ...
  {\includegraphics[width=0.43\linewidth]{truck_iotdb_write.png}}
  \subcaptionbox{挖掘机工况数据集\label{fig:excavator_write}}
  {\includegraphics[width=0.43\linewidth]{excavator_iotdb_write.png}}
...
{\includegraphics[width=0.43\linewidth]{truck_iotdb_query.png}}
\subcaptionbox{挖掘机工况数据集\label{fig:excavator_query}}
{\includegraphics[width=0.43\linewidth]{excavator_iotdb_query.png}}
